...
export default function Footer() {
  ...
  useEffect(() => {
    const cleanup = initBackToTop(".usa-footer__return-to-top", 100);
    return cleanup;
  }, []);
  ...
  return (
    <footer className="usa-footer usa-footer--nci-big flex-grow-0">
      <div className="footer">
        <div className="usa-footer__primary-section pt-4">
            ...
            <div className="row grid-gap">
              <div className="col-12 col-md-6 col-lg-4">
                <div className="usa-footer__primary-content usa-footer__primary-content--collapsible">
                  <div>
                    <span className="usa-footer__primary-link usa-footer__nci-list-header">About</span>
                    <ul className="about-list usa-list--unstyled">
                      <li className="usa-footer__secondary-link">
                        <a
                          id="aboutLink"
                          target="_blank"
                          rel="noopener noreferrer"
                          href="https://analysistools.cancer.gov/gwas-target">
                          About GWAS Target
                        </a>
                      </li>
                      <li className="usa-footer__secondary-link last-update">Last Updated: {date}</li>
                      <li className="usa-footer__secondary-link">Version: {version}</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6 col-lg-4">
                <div className="usa-footer__primary-content usa-footer__primary-content--collapsible">
                  <div>
                    <span className="usa-footer__primary-link usa-footer__nci-list-header">Resources</span>
                    <ul className="resource-list usa-list--unstyled">
                      <li className="usa-footer__secondary-link">
                        <a
                          target="_blank"
                          rel="noopener noreferrer"
              ...
              <div className="col-12 col-md-6 col-lg-4">
                <div className="usa-footer__primary-content usa-footer__primary-content--collapsible">
                  <div>
                    <span className="usa-footer__primary-link usa-footer__nci-list-header">Policies</span>
                    <ul className="resource-list usa-list--unstyled">
                      <li className="usa-footer__secondary-link">
                        <a target="_blank" rel="noopener noreferrer" href="http://www.cancer.gov/policies/accessibility">
                          Accessibility
                        </a>
                      </li>
                      <li className="usa-footer__secondary-link">
                        <a target="_blank" rel="noopener noreferrer" href="https://www.cancer.gov/policies/foia">
                          FOIA
                        </a>
                      </li>
                      <li className="usa-footer__secondary-link">
                        <a target="_blank" rel="noopener noreferrer" href="https://www.cancer.gov/policies/privacy-security">
                          Privacy &amp; Security
                        </a>
                      </li>
                      <li className="usa-footer__secondary-link">
                        <a target="_blank" rel="noopener noreferrer" href="https://www.cancer.gov/policies/disclaimer">
                          Disclaimers
                        </a>
                      </li>
                      <li className="usa-footer__secondary-link">
        ...
        <div className="usa-footer__secondary-section">
          <div className="grid-footer-container">
              ...
              <div className="usa-footer__social-links desktop:grid-col-5">
                ...
                <div className="grid-row grid-gap-1 nci-big__social">
                  <div className="grid-col-auto">
                    <a className="usa-social-link usa-social-link--facebook" href="https://www.facebook.com/cancer.gov">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" className="usa-icon" role="img" aria-labelledby="facebook-title_site">
                  ...
                  <div className="grid-col-auto">
                    <a className="usa-social-link" href="https://twitter.com/thenci">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="usa-icon" role="img" aria-labelledby="x-title">
                  ...
                  <div className="grid-col-auto">
                    <a className="usa-social-link usa-social-link--instagram" href="https://www.instagram.com/nationalcancerinstitute/">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="usa-icon" role="img" aria-labelledby="instagram-title_site">
                  ...
                  <div className="grid-col-auto">
                    <a className="usa-social-link usa-social-link--youtube" href="https://www.youtube.com/NCIgov">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="usa-icon" role="img" aria-labelledby="youtube-title_site">
                  ...
                  <div className="grid-col-auto">
                    <a className="usa-social-link usa-social-link--linkedin" href="https://www.linkedin.com/company/nationalcancerinstitute/">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="usa-icon" role="img" aria-labelledby="linkedin-title_site">
            ...
            <input className="usa-input width-full" style={{ display: "none" }} id="email" name="email" type="email" value="" aria-describedby="email-error-message" readOnly />
          </div>
        </div>
      </div>
      <div className="usa-footer__return-to-top">
        <button type="button" aria-label="Back To Top" id="backToTop" onClick={handleBackToTop}>
